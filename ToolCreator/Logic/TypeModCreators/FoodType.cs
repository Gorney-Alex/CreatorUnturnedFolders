...
public class FoodType : ICanBeCreated
{
    private int _x;
    private int _y;
    private float _z;
    ...
    public FoodType(int x, int y, float z, int health, int food, int water, int virus, int vision, int energy, string rarity, bool isForMasterBundle)
    {
        _x = x;
        _y = y;
        _z = z;
